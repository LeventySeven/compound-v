...
Then save the plan to `docs/plans/YYYY-MM-DD-<feature>.md` (user's location preference wins) and hand off to `compound-v:batched-implementation` to execute it.
